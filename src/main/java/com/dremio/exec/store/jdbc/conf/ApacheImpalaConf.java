...
@SourceType(value = "ApacheImpalaARP", label = "ApacheImpala",uiConfig = "apacheimpala-layout.json")
public class ApacheImpalaConf extends AbstractArpConf<ApacheImpalaConf> {
  private static final String ARP_FILENAME = "arp/implementation/apacheimpala-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.apacheimpala.ApacheImpalaDriver";
